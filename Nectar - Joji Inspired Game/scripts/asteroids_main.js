...
function onloadHandler()
{
   ...
   g_backgroundImg.src = 'images/background.png';
   g_backgroundImg.onload = function()
   {
      ...
      {
         GameHandler.loadSound("sounds/jojiboom.mp3", "laser");
         GameHandler.loadSound("sounds/jojienemy.mp3", "enemy_bomb");
         GameHandler.loadSound("sounds/wow.mp3", "big_boom");
...
Asteroids.Colours =
{
   ...
   ENEMY_SHIP: "rgb(154, 154, 255)",
   ENEMY_SHIP_DARK: "rgb(135, 166, 255)",
   GREEN_LASER: "rgb(255, 165, 120)",
   GREEN_LASER_DARK: "rgb(252, 139, 82)",
   GREEN_LASERX2: "rgb(252, 139, 82)",
   GREEN_LASERX2_DARK: "rgb(252, 139, 82)",
   PLAYER_BOMB: "rgb(255, 119, 10)",
   PLAYER_THRUST: "rgb(255, 0, 0)",
   PLAYER_SHIELD: "rgb(255, 213, 54)"
};
...
(function()
{
   Asteroids.Main = function()
   {
      ...
      loader.addImage(g_playerImg, 'images/jojiplayer.png');
      loader.addImage(g_asteroidImgs[0], 'images/spoon1.png');
      loader.addImage(g_asteroidImgs[1], 'images/spoon1.png');
      loader.addImage(g_asteroidImgs[2], 'images/spoon1.png');
      loader.addImage(g_asteroidImgs[3], 'images/spoon1.png');
      loader.addImage(g_shieldImg, 'images/shield.png');
      loader.addImage(g_enemyshipImg, 'images/enemybeeplayer.png');
   ...
   extend(Asteroids.AttractorScene, Game.Scene,
   {
      ...
      onRenderScene: function onRenderScene(ctx)
      {
         ...
         else
         {
            ...
            t(ctx, Game.Util.message("please-wait"), "18pt Arial", GameHandler.height*0.5, "rgb(168, 27, 11)");
         }
      },
      
      sceneRendererWelcome: function sceneRendererWelcome(ctx)
      {
         ctx.fillStyle = ctx.strokeStyle = "rgb(164, 42, 4)";
         var t = (BITMAPS ? Game.centerFillText : Game.centerDrawText);
      ...
      {
         ctx.fillStyle = ctx.strokeStyle = "rgb(255, 234, 136)";
      ...
      {
         ctx.fillStyle = ctx.strokeStyle = "rgb(216, 89, 15)";
         var t = (BITMAPS ? Game.centerFillText : Game.centerDrawText);
      ...
      sineText: function sineText(ctx, txt, xpos, ypos)
      {
         ...
         for (var i=0, j=txt.length; i<j; i++)
         {
            ...
            f(ctx, txt[i], "36pt Courier New", x + i*30, y, "rgb(128, 0, 32)");
         }
         this.sine += 0.075;
      },
...
(function()
{
   ...
   extend(Asteroids.GameOverScene, Game.Scene,
   {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            Game.fillText(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 - 32, "rgb(216, 89, 15)");
            Game.fillText(ctx, Game.Util.message("score") + ": " + this.game.score, "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5, "rgb(216, 89, 15)");
            if (this.game.score === this.game.highscore)
            {
               Game.fillText(ctx, Game.Util.message("new-high-score") + "!", "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 + 24, "rgb(216, 89, 15)");
            }
         }
         else
         {
...
(function()
{
   ...
   extend(Asteroids.GameCompleted, Game.Scene,
   {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            Game.fillText(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 96, GameHandler.height*0.5 - 32, "rgb(216, 89, 15)");
            Game.fillText(ctx, Game.Util.message("score") + ": " + this.game.score, "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5, "rgb(216, 89, 15)");
            if (this.game.score === this.game.highscore)
            {
               Game.fillText(ctx, Game.Util.message("new-high-score") + "!", "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 + 24, "rgb(216, 89, 15)");
...
(function()
{
   ...
   extend(Asteroids.GameScene, Game.Scene,
   {
      ...
      onInitScene: function onInitScene()
      {
         ...
         for (var i=1, j=(2+this.wave); i<j; i++)
         {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            var f = (BITMAPS ? Game.fillText : Game.drawText);
            f(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 48, GameHandler.height*0.5 - 8, "rgb(216, 89, 15)");
         }
         else
         {
            interval.complete = true;
      ...
      renderOverlay: function renderOverlay(ctx)
      {
         ...
         Game.fillText(ctx, sscore, "12pt Courier New", 120, 12, "rgb(216, 89, 15)");
         ...
         Game.fillText(ctx, Game.Util.message("hi-score") + ": " + sscore, "12pt Courier New", 220, 12, "rgb(216, 89, 15)");
